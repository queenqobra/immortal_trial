...
"/>
  ...
  <img
    ...
    "
    style={{
      filter: "blur(1px) drop-shadow(0 0 80px red)"
    }}
  />
      ...
      <div className="relative z-[10] w-full flex justify-center pt-[120px]">
        ...
        <div className="relative w-[90%] max-w-[1400px] mt-[-2500px]">
          ...
          <div className="relative z-[2]">
              ...
              {[...Array(16)].map((_, i) => (
                <div
                  ...
                  className="
                    ...
                    bg-gradient-to-b from-[#ffffff] via-[#e6e6e6] to-[#9e9e9e]

                    shadow-[0_0_20px_white,0_0_40px_white]
              ...
              {[...Array(8)].map((_, i) => (
                <div
                  ...
                  className="
                    ...
                    font-orbitron text-black text-[10px]
                  "
                >
                  TEAM
                </div>
            ...
            <div className="absolute right-[120px] top-[200px] flex flex-col items-center gap-6">
              ...
              <div className="
                ...
                bg-gradient-to-b from-[#2a2a2a] to-black

                shadow-[0_0_30px_black,0_0_80px_black]
          ...
          <img
            src="/red-logo.png"
            className="
              absolute right-[40px] top-[180px]
              w-[300px]
              z-[2]
              pointer-events-none
              drop-shadow-[0_0_100px_red]
            "
          />

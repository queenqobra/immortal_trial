...
export const TournamentDetailsSection = (): JSX.Element => {
  ...
  bg-gradient-to-r from-[#2e2e2e] via-[#d9d9d9] to-[#2e2e2e]
">
  <span className="
    font-literature
    text-black
...
<div className="
  absolute top-[40px] left-0 w-full h-[1500px]
  bg-gradient-to-b from-black/100 via-black/40 via-black/50 to-transparent
  pointer-events-none
  z-0
"/>
      {/* Main content area */}
  ...
  {/* фон */}
  <div className="absolute inset-0 bg-black/40 backdrop-blur-sm border border-transparent backdrop-blur-[3.75px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(3.75px)_brightness(100%)] [border-image:linear-gradient(140deg,rgba(0,0,0,0.69)_0%,rgba(141,141,141,0.69)_44%,rgba(102,102,102,0.69)_100%)_1]" />

  {/* заголовок */}
  <div className="relative font-literature text-white text-[16px] tracking-[1px]
    drop-shadow-[0_0_12px_white] text-center mb-6">
    ФОРМАТ ТУРНИРА
            </div>
            ...
            <img
  src="/Star.png"
  className=" scale-[6] absolute w-[90px] h-[90px] top-[22%] left-1/2 -translate-x-1/2 
  drop-shadow-[0_0_25px_white]"
/>
          </div>
...
/>
  ...
  <div className="absolute inset-0 bg-black/40 backdrop-blur-sm border border-transparent backdrop-blur-[3.75px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(3.75px)_brightness(100%)] [border-image:linear-gradient(140deg,rgba(0,0,0,0.69)_0%,rgba(141,141,141,0.69)_44%,rgba(102,102,102,0.69)_100%)_1]" />
          <div className="absolute w-[93.59%] h-[18.38%] top-[50%] left-[3.56%] font-labor text-white text-[10px] tracking-[0.30px] leading-[40px] font-normal text-center">
              <span className="tracking-[0.03px]">
                 ОГРАНИЧЕНИЯ ПО РЕЙТИНГУ НА КОМАНДУ <br />
              </span>
...
/>
        ...
        <div className="relative z-10 w-[899px] h-[395px]">
          ...
          <img
  src="/Star.png"
  className=" scale-[6] absolute w-[90px] h-[90px] top-[45%] right-[90.5%] 
  drop-shadow-[0_0_25px_white]"
/>
          <img
  src="/Star.png"
  className=" scale-[6] absolute w-[90px] h-[90px]  top-[45%] left-[95.5%]  -translate-x-1/2 
  drop-shadow-[0_0_25px_white]"
/>
        </div>
      </div>
      ...
      <div className="
  absolute bottom-0 left-0 w-full h-[700px]
  bg-gradient-to-t from-black via-black/90 to-transparent
  z-0
  pointer-events-none
" />
<div className="
  absolute bottom-0 left-0 w-full h-[300px]
